...
const Header = () => {
  ...
  return (
    <div className='flex  flex-col mt-20 px-4 text-center text-gray-800  items-center '>
        <h1 className='flex items-center  sm:text-9xl text-3xl mb-10'>👽</h1>
        <h1 className='text-xl font-bold shadow-gray-400 mb-3'>Heyy {userdata?.username || 'Developer'}.. 👋🏻</h1>
